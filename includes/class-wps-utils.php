...
class WPS_Utils {
	...
	public static function event_severity( string $type ): string {
		...
		$exact = [
			...
			'headless_plugin_folder_found'  => 'critical',
			'constant_assembled_calls_found' => 'critical',
			'headless_folder_option_cleared' => 'high',
			'sso_bypass_blocked'            => 'warning',
			'sso_token_cleared'             => 'high',
			'unattributed_plugin_found'     => 'critical',
			'plugin_reinstalled_repeatedly' => 'high',
			'policy_install_blocked' => 'high',
			'malware_source_attributed'     => 'high',
			'malware_source_blocked'        => 'high',
			'c2_request_blocked'            => 'high',
			'c2_host_blocked'               => 'high',
